...
from app.services.tdee import calculate_age_years, mifflin_st_jeor, recalculate_user_tdee
...
class ProfileUpdateRequest(BaseModel):
    ...
    target_weight_kg: float | None = None
    target_monthly_rate_kg: float | None = None
    min_daily_calories: float | None = None
    protein_ratio: float | None = None
    carbs_ratio: float | None = None
...
def update_user_profile(
    req: ProfileUpdateRequest, user: UserProfile = Depends(get_current_user), db: Session = Depends(get_db)
):
