...
* 📁 **Smart Data File Import**: Send `.json`, `.json.gz`, `.xlsx` Excel spreadsheets, or CSV dumps from third-party apps (MyFitnessPal, LoseIt, Apple Health). Gemini parses column structures, asks for clarification if needed, and imports records into `ctracker`.
